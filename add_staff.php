...
<html>
	<head>
		<title>Schoool Management</title>
		<link rel="stylesheet" type="text/css" href="css/style.css">
	</head>
	
	<body>
			<?php include"navbar.php";?><br>
			<img src="img/manage.jpg" style="margin-left:90px;" class="sha" width="1350" height="320">
			...
			<div id="section">
				...
				<div class="content1">
					...
					<?php
						...
						{
							$sq="insert into staff(TNAME,TPASS,QUAL) values('{$_POST["sname"]}',1234,'{$_POST["qual"]}')";
							$ssq="insert into staff_info(SAL) values({$_POST["sal"]}')";
